...
import { wqDisplay, wqInkOffset, loadBundle, getSurahMeta } from '@/lib/data';
 ...
 */
export default function VerseCard({ verse, showEn, showUr, showTr, onAnyPlay, active, bandName }: VerseCardProps) {
  ...
  return (
    <article
      id={`v${verse.v}`}
      className={['vcard relative', playing && 'now-playing', active && 'reciting', bandName && 'band'].filter(Boolean).join(' ')}
